...
A vet has been assigned to work at a farm where 70% of the animals have been infected by avian influenza. What is the probability that 3 of the selected animals are infected? 
...
$P(X = 3) = f(x) = {10 \choose 3}0.70^{3} (1-0.70)^{10-3}$
